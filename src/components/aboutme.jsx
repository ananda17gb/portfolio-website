  ...
  return (
    ...
    <div id="aboutme" className="flex flex-col h-[90vh] ">
        <div className="flex justify-between px-80 items-center h-screen">
            ...
            <br/>
            <p className="font-medium text-xl">Hello my name is <span className="font-bold">Ananda Arti Widigdo</span>,</p>
            <p className="font-medium text-xl">a student from Telkom University majoring in Informatics</p>
            <p className="font-medium text-xl">having interest in technology and software engineering</p>
            <div className="flex gap-5 items-center my-4" >
            <a href="https://wa.me/6281222693760" target="_blank">
                <FaWhatsapp size={36}/>
            </a>
            <a href="https://linkedin.com/in/ananda-arti-widigdo-b08178247" target="_blank">
